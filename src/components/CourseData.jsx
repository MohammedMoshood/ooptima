      ...
      <div className="curriculum-panel">
        <div className="course-progress">
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            <div>Average Course Progress</div>
            <div>10%</div>
          </div>
          <div>
        ...
        <div className="course-curriculum">
          ...
          <div className="topic">
            <span className="topic-title">Introduction to Cybersecurity </span>
            <span style={{ color: "#151515" }} className="sub-topic">
      ...
      <div className="course-content">
        ...
        >
          ...
          <p>
            ...
            communications from cybercriminals. For businesses, cybersecurity is
            crucial for protecting intellectual property, customer data, and
            financial information. A single security breach can result in
          ...
          <h2 style={{ margin: "10px 0" }}>Real-Life Cybersecurity Threats</h2>
          <p>
          ...
          <ul style={{ listStyleType: "square", paddingLeft: "20px" }}>
            ...
            <li>
              <strong>Phishing</strong>: Fraudulent attempts to obtain sensitive
              information by disguising as a trustworthy entity in electronic
              communications.
            </li>
            <li>
              <strong>Denial of Service (DoS) Attacks</strong>: Attempts to make
            ...
            <li>
              <strong>SQL Injection</strong>: Inserting malicious SQL code into
              a query to manipulate or destroy a database.
            </li>
            <li>
          ...
          <ul style={{ listStyleType: "square", paddingLeft: "20px" }}>
            <li>
              <strong>Firewalls</strong>: These act as barriers between trusted
              and untrusted networks, monitoring and controlling incoming and
            ...
            <li>
              <strong>Encryption</strong>: Protecting data by converting it into
          ...
          <ul style={{ listStyleType: "square", paddingLeft: "20px" }}>
            <li>
              <strong>Security Awareness Training</strong>: Educating employees
              and individuals about the importance of cybersecurity and how to
              recognize and respond to threats.
            </li>
            <li>
              <strong>Strong Password Policies</strong>: Encouraging the use of
              complex, unique passwords and regular password changes.
            </li>
            <li>
          ...
          <p>
            ...
            for stronger data protection measures and more stringent regulatory
            compliance.
          </p>
          ...
          <p>
            ...
            and predict potential attacks. However, cybercriminals can also use
            these technologies to develop more sophisticated and
            harder-to-detect attacks.
          </p>
          <p>
            In conclusion, cybersecurity is an ongoing battle that requires
            vigilance, innovation, and collaboration. By staying informed about
            the latest threats and continuously improving security measures,
            individuals, businesses, and governments can protect their digital
            assets and ensure a safer digital world.
          </p>
        </div>
      </div>
    </section>
